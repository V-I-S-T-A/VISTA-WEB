...
import { buildLogDetails } from "./auditLogData";

export default function AuditLogDetails({ log, onBack }) {
  const details = useMemo(() => buildLogDetails(log), [log]);
    ...
    <div className="mx-4 sm:mx-6 lg:mx-8 my-4">
      ...
      <section className="overflow-hidden rounded-xl border border-gray-200 bg-white">
        <div style={{ padding: "24px 28px" }}>
          ...
          {/* Impacted Entities + Context Timeline */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-5">
            ...
            <div className="rounded-lg border border-gray-200 overflow-hidden">
              ...
              <div
                ...
                style={{ padding: "14px" }}
              >
                {details.impactedEntities.map((entity) => (
                  <div
                    key={entity.id}
                  ...
                  >
                    <span
                      ...
                      style={{
                        backgroundColor:
                          entity.type === "student" ? "#1f5cae" : "#fbbf24",
                      }}
                    >
                      {entity.type === "student" ? (
                        <GraduationCap
