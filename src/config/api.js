...
export const API_ENDPOINTS = {
  ...
  AUTH: {
    ...
    REQUEST_PASSWORD_CHANGE_CODE: `${API_CONFIG.ENDPOINTS.AUTH}/change-password/request-code/`,
    CONFIRM_PASSWORD_CHANGE: `${API_CONFIG.ENDPOINTS.AUTH}/change-password/confirm/`,
  },
  ORGANIZATIONS: {
